...
MODEL_SPECS: dict[str, CriterionModelSpec] = {
    "positivity": CriterionModelSpec(
        ...
        model_dir=DEFAULT_MODELS_DIR / "positivity_phobert" / "final_model",
        max_length=256,
    ...
    "toxicity": CriterionModelSpec(
        ...
        max_length=256,
        score_map={"clean": 5, "toxic": 1},
        high_signal="Khong thay dau hieu ngon ngu cong kich hoac doc hai ro rang.",
        low_signal="Co dau hieu ngon ngu gay gat, cong kich, do loi hoac toxic.",
    ),
